...
#env invocation
If `env` is run in a shell setting without additional arguments, it will print out a list of environment variables associated with the current user. This is equivalent to `printenv`, which brings up a complete list of environment variables. 
