...
As stated above, getcwd gets the c-string containing the current working directory. 
...
For example, if you created `char directory[250]`, you’d pass in `directory, 250`.
