...
We now know the basics of how `strtok` works, but still do not have an explanation for why.
...
In the previous section [The Basics](#the-basics), it was stated that to get the token.
