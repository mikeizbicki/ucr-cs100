...
### Contents
  - [Introduction To strtok](#introduction-to-strtok)
    - [The Basics](#the-basics)
    - [The NULL Argument](#the-null-argument)
  - Failure And Edge Cases
    - [Failure](#failure)
    - [Delimiters At The Ends And Chained Delimiters](#delimiters-at-the-ends-and-chained-delimiters)
    - [Multi-Character And Changing Delimiters](#multi-character-and-changing-delimiters)
  - [Parsing Multiple Strings](#parsing-multiple-strings)
