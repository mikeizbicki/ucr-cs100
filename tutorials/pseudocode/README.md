...
If you are comfortable writing programs without pseudocode there is one significant advantage to adding pseudocode to your repertoire... It allows you to think through the entire logic of your code and how it interacts with other parts of the program (if you are working in a brownfield environment). This also helps to ensure that if you are using test-driven development (TDD) you already have a strong image of how all the necessary subcomponents are going to come together, making the refactoring component of TDD simple.
