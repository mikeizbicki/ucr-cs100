...
To implement `ls`, you must use the `readdir` and `stat` syscalls.  For details on the use of these functions, visit their main pages. After visiting their man pages, you may checkout this video guide on directories.
