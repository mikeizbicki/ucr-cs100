...
To implement `ls`, you must use the `readdir` and `stat` syscalls.  For details on the use of these functions, visit their man pages. After visiting their man pages, you may checkout the [video guide on directories](../../../tutorials/syscalls/syscallvideos.md).
