...
The [syscalls tutorial from hw0](https://github.com/mikeizbicki/ucr-cs100/blob/cs100-2014fall/tutorials/syscalls/README.md) as well as [this video guide](../../../tutorials/syscalls/syscallvideos.md) also covers these functions.
